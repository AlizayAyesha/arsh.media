      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          <button
            type="button"
            onClick={onReadMore}
            className="group inline-flex w-full shrink-0 items-center justify-center gap-2.5 bg-champagne px-7 py-3.5 text-[11px] font-semibold uppercase tracking-[0.18em] text-on-accent transition-colors hover:bg-[#e8d9b5] sm:w-auto"
          >
            Read the archive
